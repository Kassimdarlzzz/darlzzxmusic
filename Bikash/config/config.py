...
API_ID = int(getenv("18641113", "18641113"))
API_HASH = getenv("bc5fea81e7bf9f3c0784a0a7d35f9c71")
BOT_TOKEN = getenv("5673232199:AAFDwlz2T7U22NONiyJWKOBNuWgKaC_xnLY")
MONGO_DB_URI = getenv("mongodb+srv://Kassim:<password>@cluster0.xu8l6p5.mongodb.net/?retryWrites=true&w=majority", None)
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", "300"))
SONG_DOWNLOAD_DURATION = int(getenv("SONG_DOWNLOAD_DURATION_LIMIT", "180"))
LOG_GROUP_ID = int(getenv("-1001893536189", "-1001893536189"))
COMMAND_PREFIXES = list(getenv("COMMAND_PREFIXES", "/ ! .").split())
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", " BIKASH ADITYA PLAYER")
OWNER_ID = list(map(int, getenv("OWNER_ID", "").split()))
HEROKU_API_KEY = getenv("53d3e9d1-79aa-4f60-8456-cdba33910222")
HEROKU_APP_NAME = getenv("darlzzzmusicc")
